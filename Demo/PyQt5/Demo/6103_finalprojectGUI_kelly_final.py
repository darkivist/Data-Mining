#Paul Kelly
#Final Project GUI: All Mushrooms are edible, but some only once in a lifetime
#06/19/2022
#DATS 6103

#Cite: GUI code is adapted from https://github.com/amir-jafari/Data-Mining/blob/master/Demo/PyQt5/Demo/Main.py
#ROC boxes commented out due to errors that could not be corrected in time
...
class RandomForest(QMainWindow):
    ...
    def initUi(self):
        ...
        # We create a checkbox of each feature
    ...
    def update(self):
        ...
        ##  Confusion Matrix
        #::------------------------------------
        class_names1 = ff_mushroom['class'].unique()
...
class PoisonousGraphs(QMainWindow):
    ...
    def update(self):
        ...
        # score of poisonous/edible and the feature chosen on the canvas
        #::--------------------------------------------------------
        colors=["b", "r", "g", "y", "k", "c"]
        self.ax1.clear()
...
class App(QMainWindow):
    ...
    def initUI(self):
        ...
        # Initial Assessement : Histogram about the level of poisonousness in 2017
        ...
        EDA2Button = QAction(QIcon('analysis.png'), 'Class vs Features', self)
        EDA2Button.setStatusTip('Class vs Features Graph')
    ...
    def EDA1(self):
        ...
        dialog.m.ax.set_xlabel("Edible or Poisonous")
        #dialog.m.ax.set_ylabel("Bruises")
...
def data_mushroom():
    ...
    class_names = ff_mushroom['class'].unique()
